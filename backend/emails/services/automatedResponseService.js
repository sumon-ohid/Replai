...
class AutomatedResponseService {
   ...
   */
  static async createDraftResponse(account, userId, email, newEmail, emailId, emailResponse) {
    try {
      ...
      if (account.provider === 'google') {
        ...
        throw new Error(`Unsupported provider for draft creation: ${account.provider}`);
      }
