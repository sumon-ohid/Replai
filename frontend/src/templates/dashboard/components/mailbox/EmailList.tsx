...
export default function EmailList({
  ...
  const handleSelectEmail = (event: React.ChangeEvent<HTMLInputElement>, emailId: string) => {
    event.stopPropagation();
    ...
    <Box>
        ...
        {loading ? (
          ...
          Array.from(new Array(10)).map((_, index) => (
            <ListItem key={index} disablePadding divider>
              <Box sx={{ width: '100%', display: 'flex', py: 1, px: 2 }}>
                <Box sx={{ display: 'flex', alignItems: 'center', mr: 2, width: 24 }}>
                  <Skeleton variant="circular" width={20} height={20} />
                </Box>
                <Box sx={{ display: 'flex', alignItems: 'center', mr: 2, width: 40 }}>
          ...
          emails.map(email => (
            <ListItem
              ...
              sx={{
                bgcolor: !email.isRead ? alpha(theme.palette.primary.light, 0.08) : 'inherit',
              }}
            >
              <ListItemButton
                ...
                <ListItemText
                  primary={
                    <Box sx={{ display: 'flex', alignItems: 'center' }}>
                      ...
                      >
                        {currentFolder === 'sent' ? email.to[0].name || email.to[0].email : email.from.name || email.from.email}
                      </Typography>
      ...
      >
        ...
        >
          ...
          <ListItemText>
            {emails.find((e) => e.id === activeEmailId)?.isRead ? 'Mark as unread' : 'Mark as read'}
          </ListItemText>
        </MenuItem>
        ...
        >
          ...
          <ListItemText>
            {emails.find((e) => e.id === activeEmailId)?.isStarred ? 'Remove star' : 'Star'}
          </ListItemText>
        </MenuItem>
