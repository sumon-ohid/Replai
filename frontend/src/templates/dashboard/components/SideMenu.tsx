...
const Drawer = styled(MuiDrawer)(({ theme }) => ({
  ...
  '& .MuiDrawer-paper': {
    ...
    background: theme.palette.mode === 'dark'
      ? `linear-gradient(180deg, ${alpha(theme.palette.background.paper, 0.96)} 0%, ${alpha(theme.palette.background.paper, 0.98)} 100%)`
      : `linear-gradient(180deg, ${alpha(theme.palette.background.paper, 0.96)} 0%, ${alpha('#f8f9fa', 0.98)} 100%)`,
...
export default function SideMenu() {
  ...
  const planColor = theme.palette.mode === 'dark' ? theme.palette.primary.light : theme.palette.primary.dark;
      ...
      <Box sx={{ px: 1, py: 1 }}>
        <Box
          ...
          sx={{
            ...
            background: theme.palette.mode === 'dark'
              ? `linear-gradient(145deg, ${alpha(theme.palette.background.default, 0.8)}, ${alpha(theme.palette.grey[900], 0.9)})`
              : `linear-gradient(145deg, ${alpha(theme.palette.background.default, 0.8)}, ${alpha(theme.palette.grey[100], 0.9)})`,
            border: '1px solid',
          ...
          >
            <Box 
              sx={{ 
                ...
                background: `linear-gradient(45deg, ${alpha(planColor, 0.2)}, ${alpha(planColor, 0.1)})`,
                border: '1px solid',
