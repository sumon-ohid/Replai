    ...
    <AppTheme {...props} themeComponents={xThemeComponents}>
      ...
      <Box sx={{ display: 'flex' }}>
        ...
        >
          ...
          <Box sx={{ mx: 3, mb: 3 }}>
            <Typography variant="h4" ml={1}>About us</Typography>
            <Typography variant="body1" color="textSecondary" align='left' ml={1}>
              We are a team of developers who are passionate about building high-quality software.
              Our goal is to help you build better software faster.
            </Typography>
            <UnderConstruction />
